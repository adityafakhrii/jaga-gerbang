...
<head>
  ...
  <link href="{{asset('asset/css/style-responsive.cs')}}s" rel="stylesheet">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-lg-offset-3 p404 centered">
        <img src="{{asset('asset/img/500.png')}}" alt="">
        <h1>ERROR 500</h1>
        <h3>Ouch!! Ada Yang Salah !</h3>
        <br>
        <h5 class="mt">Hai, mungkin anda akan mengunjungi halaman ini :</h5>
        <p><a href="/">Halaman Utama</a> | <a href="/login">Login</a></p>
      </div>
    </div>
  </div>
